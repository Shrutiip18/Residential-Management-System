...
<input type="checkbox" id="check">
    ...
    <div class="sidebar">
      ...
      <a href="bookfacility.php" class="active"><i class="fas fa-coffee"></i><span>Facility Booking</a>
    </div>
    <!--sidebar end--> 
    <div class="content"><br><br><br><br>
    <?php
    $connection = mysqli_connect("localhost","root","");
    $db = mysqli_select_db($connection,'facilitydb');  // Database name for facility booking

    $query = "SELECT * FROM facilities";  // SQL query to fetch facilities
    ...
    <table class="content-table">
      ...
      <tbody>
        <tr>
          ...
          <td><a href="bookfacility.php?facility_id=<?php echo $row['facility_id']; ?>" class="btn">Book Now</a></td>
        </tr>
      </tbody>
      <?php
          }
